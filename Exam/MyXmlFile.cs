...
namespace ExamConsole
{
    public class MyXmlFile : IMyXmlFile
    {
        ...
        bool IMyXmlFile.ExistFile(string path)
        {
            throw new NotImplementedException();
        }

        IVictorina IMyXmlFile.GetVictorina(string path)
        {
            throw new NotImplementedException();
        }

        bool IMyXmlFile.SaveVictorina(string path, IVictorina victorina)
        {
            throw new NotImplementedException();
        }
        ...
        bool IMyXmlFile.SaveUser(string path, IUser user, bool rewrite)
        {
            throw new NotImplementedException();
        }

        ResultTable IMyXmlFile.GetResultTable(string path)
        {
            throw new NotImplementedException();
        }

        bool IMyXmlFile.SaveResultTable(string path, ResultTable rt)
        {
            throw new NotImplementedException();
        }

        IMassiveVictorins IMyXmlFile.GetAllVictorins()
        {
            throw new NotImplementedException();
        }
